  ...
  if (done) {
    return (
      <div style={{ padding: 24, textAlign: "center", paddingBottom: 80 }}>
        ...
        <div style={{ fontSize: 22, fontWeight: 800, color: "#16a34a", marginBottom: 8 }}>
          Захиалга амжилттай!
        </div>
        ...
        <div
          style={{
            ...
            background: "#e0e7ff", padding: "12px 24px",
            borderRadius: 14, display: "inline-block", marginBottom: 20,
          }}
        >
          {done}
        </div>
  ...
  return (
    <div style={{ padding: 16, paddingBottom: 100 }}>
      ...
      <Select
        ...
        onChange={v => set("item_size", v)}
        options={ITEM_SIZES.map(s => ({ value: s, label: s }))}
      />
      ...
      <PrimaryBtn
        ...
        onClick={() => {
          if (
            !form.sender_name || !form.sender_phone || !form.pickup_address ||
            !form.receiver_name || !form.receiver_phone || !form.dropoff_address ||
