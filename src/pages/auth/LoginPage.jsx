...
export default function LoginPage({ onLogin, onGoRegister, onGuestOrder }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(160deg,#1a1a2e 0%,#16213e 60%,#0f3460 100%)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div style={{ marginBottom: 32, textAlign: "center" }}>
        <div style={{ fontSize: 56 }}>🚀</div>
        <div style={{ color: "#fff", fontSize: 28, fontWeight: 800, letterSpacing: -0.5 }}>Хүргэлтийн Апп</div>
      ...
      <div style={{ background: "#fff", borderRadius: 20, padding: 28, width: "100%", maxWidth: 380 }}>
        ...
        {err && (
          <div style={{ color: "#dc2626", fontSize: 13, marginBottom: 12, background: "#fee2e2", padding: "8px 12px", borderRadius: 8 }}>{err}</div>
        )}
        ...
        <button
          ...
          style={{ width: "100%", padding: "12px 20px", border: "2px dashed #d0d0d0", borderRadius: 12, background: "#fafafa", color: "#444", fontSize: 15, fontWeight: 600, cursor: "pointer", fontFamily: "inherit", marginBottom: 18 }}
        >
