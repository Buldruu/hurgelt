    ...
    <div style={{ maxWidth: 480, margin: "0 auto", minHeight: "100vh", background: "#f8f9fa", fontFamily: "system-ui,sans-serif" }}>
      ...
      {tab === "home" && (
        <div style={{ padding: 16, paddingBottom: 80 }}>
          ...
          <PrimaryBtn full onClick={() => setTab("create")} style={{ marginBottom: 16, fontSize: 17, padding: "16px 20px" }}>
        ...
        <div style={{ padding: 16, paddingBottom: 80 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
            ...
            <div style={{ background: "#f0fdf4", borderRadius: 14, padding: 16, textAlign: "center" }}>
              <div style={{ fontSize: 24, fontWeight: 800, color: "#16a34a" }}>{myDels.filter(d => state.deliveries.find(x => x.id === d.id)?.status === "delivered").length}</div>
